...
## Принцип: дизайн страниц — от работы пользователя (JTBD), затем устоявшиеся паттерны

**Проектируя любую страницу/экран, рассуждай как продуктовый менеджер: сначала пойми работу
(Job To Be Done), которую пользователь «нанимает» эту страницу выполнить, и строй дизайн вокруг
прогресса пользователя к его результату — а не вокруг данных, которые удобно показать, или красивого
макета.** Во вторую очередь, по возможности, опирайся на устоявшиеся, узнаваемые паттерны интерфейса,
чтобы пользователь вникал мгновенно, без лишней когнитивной нагрузки.
