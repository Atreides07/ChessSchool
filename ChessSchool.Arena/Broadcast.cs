...
public static class BroadcastSeed
{
    ...
    [
        new() { Slug = "superunited-rapid-blitz-croatia-2026", Name = "SuperUnited Rapid & Blitz Croatia", Series = "Grand Chess Tour", SeriesCls = "gct", Start = new(2026, 6, 29), End = new(2026, 7, 6), City = "Загреб", Country = "Хорватия", Flag = "🇭🇷", Format = "Рапид и блиц", Url = "https://grandchesstour.org" },
        new() { Slug = "biel-chess-festival-2026", Name = "Biel Chess Festival", Series = "Классика", SeriesCls = "cls", Start = new(2026, 7, 11), End = new(2026, 7, 24), City = "Биль", Country = "Швейцария", Flag = "🇨🇭", Format = "Классика · 2700+", Url = "https://www.bielchessfestival.ch" },
        new() { Slug = "chennai-grand-masters-2026", Name = "Chennai Grand Masters", Series = "Классика", SeriesCls = "cls", Start = new(2026, 7, 15), End = new(2026, 7, 23), City = "Ченнаи", Country = "Индия", Flag = "🇮🇳", Format = "Классика · круговой", Url = "https://en.wikipedia.org/wiki/2026_in_chess" },
        new() { Slug = "saint-louis-rapid-blitz-2026", Name = "Saint Louis Rapid & Blitz", Series = "Grand Chess Tour", SeriesCls = "gct", Start = new(2026, 7, 31), End = new(2026, 8, 7), City = "Сент-Луис", Country = "США", Flag = "🇺🇸", Format = "Рапид и блиц", Url = "https://grandchesstour.org" },
        new() { Slug = "sinquefield-cup-2026", Name = "Sinquefield Cup", Series = "Grand Chess Tour", SeriesCls = "gct", Start = new(2026, 8, 8), End = new(2026, 8, 21), City = "Сент-Луис", Country = "США", Flag = "🇺🇸", Format = "Классика · элита", Url = "https://grandchesstour.org" },
        new() { Slug = "cairns-cup-2026", Name = "Cairns Cup", Series = "Женский элит", SeriesCls = "wom", Start = new(2026, 8, 8), End = new(2026, 8, 21), City = "Сент-Луис", Country = "США", Flag = "🇺🇸", Format = "Классика · круговой", Url = "https://saintlouischessclub.org" },
        new() { Slug = "gct-finals-2026", Name = "GCT Finals", Series = "Grand Chess Tour", SeriesCls = "gct", Start = new(2026, 8, 21), End = new(2026, 8, 28), City = "Сент-Луис", Country = "США", Flag = "🇺🇸", Format = "Плей-офф · топ-4", Url = "https://grandchesstour.org" },
    ];
}
