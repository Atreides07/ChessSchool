...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string Ru, string En)> Ui = new()
    {
        ...
        ["rules.berserk"] = ("⚡ Берсерк — победа", "⚡ Berserk — win"),
        ["rules.berserkbonus"] = ("+ 2", "+ 2"),
        ["rules.berserkhint"] = ("Берсерк: вдвое меньше времени и без прибавки за ходы. Доступен до первого хода.",
            "Berserk: half the clock and no increment per move. Available before your first move."),
