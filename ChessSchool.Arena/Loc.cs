...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string Ru, string En)> Ui = new()
    {
        ...
        ["admin.f.image.hint"] = ("Ссылка с официального сайта турнира или источника новости. Файл не загружается на сервер.",
                                  "Link from the official tournament site or a news source. The file is not uploaded to the server."),
